...
function findWasmBinary() {
  return locateFile('hdr-image-explorer.wasm');
}
...
var ASM_CONSTS = {
  5328062: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 5328095: () => { return window.devicePixelRatio },  
 5328130: () => { return Module.numWindows; },  
 5328160: () => { return Module.events.length; },  
 5328193: () => { window.id },  
 5328205: () => { return window.innerWidth },  
 5328232: () => { return window.innerHeight },  
 5328260: () => { return window.innerWidth },  
 5328287: () => { return window.innerHeight },  
 5328315: () => { return Date.now() / 1000.0; },  
 5328347: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; },  
 5328428: () => { return canvas.getBoundingClientRect().x },  
 5328470: () => { return canvas.getBoundingClientRect().y },  
 5328512: () => { return canvas.getBoundingClientRect().x },  
 5328554: () => { return canvas.getBoundingClientRect().y }
};
