...
function findWasmBinary() {
    return locateFile('gouraud.wasm');
}
...
var ASM_CONSTS = {
  4211866: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4211899: () => { return Module.numWindows; },  
 4211929: () => { return Module.events.length; },  
 4211962: () => { window.id },  
 4211974: () => { return window.innerWidth },  
 4212001: () => { return window.innerHeight },  
 4212029: () => { return window.innerWidth },  
 4212056: () => { return window.innerHeight },  
 4212084: () => { return Date.now() / 1000.0; },  
 4212116: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
