...
var ASM_CONSTS = {
  4212945: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4212978: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4213049: () => { return Module.numWindows; },  
 4213079: () => { return Module.events.length; },  
 4213112: () => { window.id },  
 4213124: () => { return window.innerWidth },  
 4213151: () => { return window.innerHeight },  
 4213179: () => { return window.innerWidth },  
 4213206: () => { return window.innerHeight },  
 4213234: () => { return Date.now() / 1000.0; },  
 4213266: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
