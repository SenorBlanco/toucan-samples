...
var ASM_CONSTS = {
  4209956: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4209989: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4210060: () => { return Module.numWindows; },  
 4210090: () => { return Module.events.length; },  
 4210123: () => { return Date.now() / 1000.0; }
};
...
var ___start_em_js = Module['___start_em_js'] = 4208016;
var ___stop_em_js = Module['___stop_em_js'] = 4209956;
