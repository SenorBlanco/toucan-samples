...
var ASM_CONSTS = {
  4210209: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4210242: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4210313: () => { return Module.numWindows; },  
 4210343: () => { return Module.events.length; },  
 4210376: () => { window.id },  
 4210388: () => { return window.innerWidth },  
 4210415: () => { return window.innerHeight },  
 4210443: () => { return window.innerWidth },  
 4210470: () => { return window.innerHeight },  
 4210498: () => { return Date.now() / 1000.0; },  
 4210530: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
...
var ___start_em_js = Module['___start_em_js'] = 4208296;
var ___stop_em_js = Module['___stop_em_js'] = 4210209;
