...
var ASM_CONSTS = {
  11174481: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 11174514: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 11174585: () => { return Module.numWindows; },  
 11174615: () => { return Module.events.length; },  
 11174648: () => { window.id },  
 11174660: () => { return window.innerWidth },  
 11174687: () => { return window.innerHeight },  
 11174715: () => { return window.innerWidth },  
 11174742: () => { return window.innerHeight },  
 11174770: () => { return Date.now() / 1000.0; },  
 11174802: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
...
var ___start_em_js = Module['___start_em_js'] = 11172568;
var ___stop_em_js = Module['___stop_em_js'] = 11174481;
