...
function findWasmBinary() {
    return locateFile('springy-compute-3d.wasm');
}
...
var ASM_CONSTS = {
  4226922: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4226955: () => { return Module.numWindows; },  
 4226985: () => { return Module.events.length; },  
 4227018: () => { window.id },  
 4227030: () => { return window.innerWidth },  
 4227057: () => { return window.innerHeight },  
 4227085: () => { return window.innerWidth },  
 4227112: () => { return window.innerHeight },  
 4227140: () => { return Date.now() / 1000.0; },  
 4227172: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
