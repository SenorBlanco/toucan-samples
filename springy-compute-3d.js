...
var wasmBinaryFile;
  wasmBinaryFile = 'springy-compute-3d.wasm';
...
var ASM_CONSTS = {
  4223511: ($0, $1, $2, $3) => { var w; var canvas; if (Module.numWindows == 0) { w = window; canvas = w.document.getElementById('canvas'); canvas.width = $2; canvas.height = $3; Module.requestFullscreen = () => { canvas.requestFullscreen(); } } else { w = window.open("", "", "left=" + $0 + ", top=" + $1 + ", width=" + $2 + ", height=" + $3); w.document.body.style.margin = 0; var canvas = w.document.createElement("canvas"); canvas.style.display = "block"; w.document.body.appendChild(canvas); } w.onbeforeunload = function() { Module.numWindows--; }; w.onmousedown = w.onmouseup = w.onmousemove = (e) => { e.preventDefault; Module.events.push(e); if (Module.newInput) Module.newInput(); }; w.oncontextmenu = (e) => {e.preventDefault()}; specialHTMLTargets["!toucanvas"] = canvas; Module.numWindows++; },  
 4224287: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4224358: () => { return Module.numWindows; },  
 4224388: () => { return Module.events.length; },  
 4224421: () => { return Date.now() / 1000.0; }
};
...
// end include: preamble.js
  ...
  _wgpuBindGroupLayoutReference.sig = 'vp';
  ...
  var _wgpuCommandEncoderReference = (id) => WebGPU.mgrCommandEncoder.reference(id);
  _wgpuCommandEncoderReference.sig = 'vp';
  ...
  var _wgpuComputePassEncoderReference = (id) => WebGPU.mgrComputePassEncoder.reference(id);
  _wgpuComputePassEncoderReference.sig = 'vp';
  ...
  _wgpuDeviceCreateSwapChain.sig = 'pppp';
  ...
  _wgpuQuerySetRelease.sig = 'vp';

  var _wgpuQueueReference = (id) => WebGPU.mgrQueue.reference(id);
  _wgpuQueueReference.sig = 'vp';

  var _wgpuQueueRelease = (id) => WebGPU.mgrQueue.release(id);
  _wgpuQueueRelease.sig = 'vp';
  ...
  _wgpuRenderPassEncoderDraw.sig = 'vpiiii';
  ...
  _wgpuRenderPassEncoderReference.sig = 'vp';
...
var wasmImports = {
  ...
  /** @export */
  __asyncjs__JSInitDevice: __asyncjs__JSInitDevice,
  /** @export */
  __asyncjs__JSWaitForNextEvent: __asyncjs__JSWaitForNextEvent,
  /** @export */
  __asyncjs__JSWaitForRAF: __asyncjs__JSWaitForRAF,
  /** @export */
  ...
  /** @export */
  wgpuCommandEncoderReference: _wgpuCommandEncoderReference,
  /** @export */
  ...
  /** @export */
  wgpuComputePassEncoderReference: _wgpuComputePassEncoderReference,
  /** @export */
...
var ___start_em_js = Module['___start_em_js'] = 4222584;
var ___stop_em_js = Module['___stop_em_js'] = 4223511;
