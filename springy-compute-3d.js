...
var ASM_CONSTS = {
  4225129: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4225162: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4225233: () => { return Module.numWindows; },  
 4225263: () => { return Module.events.length; },  
 4225296: () => { window.id },  
 4225308: () => { return window.innerWidth },  
 4225335: () => { return window.innerHeight },  
 4225363: () => { return window.innerWidth },  
 4225390: () => { return window.innerHeight },  
 4225418: () => { return Date.now() / 1000.0; },  
 4225450: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
...
var ___start_em_js = Module['___start_em_js'] = 4223216;
var ___stop_em_js = Module['___stop_em_js'] = 4225129;
