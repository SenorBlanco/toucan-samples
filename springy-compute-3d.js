...
var ASM_CONSTS = {
  4228937: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4228970: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4229041: () => { return Module.numWindows; },  
 4229071: () => { return Module.events.length; },  
 4229104: () => { window.id },  
 4229116: () => { return window.innerWidth },  
 4229143: () => { return window.innerHeight },  
 4229171: () => { return window.innerWidth },  
 4229198: () => { return window.innerHeight },  
 4229226: () => { return Date.now() / 1000.0; },  
 4229258: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
