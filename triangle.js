...
var ASM_CONSTS = {
  4209756: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4209789: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4209860: () => { return Module.numWindows; },  
 4209890: () => { return Module.events.length; },  
 4209923: () => { return Date.now() / 1000.0; },  
 4209955: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
...
var ___start_em_js = Module['___start_em_js'] = 4207816;
var ___stop_em_js = Module['___stop_em_js'] = 4209756;
