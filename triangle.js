...
var ASM_CONSTS = {
  4209740: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4209773: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4209844: () => { return Module.numWindows; },  
 4209874: () => { return Module.events.length; },  
 4209907: () => { return Date.now() / 1000.0; },  
 4209939: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
...
var ___stop_em_js = Module['___stop_em_js'] = 4209740;
