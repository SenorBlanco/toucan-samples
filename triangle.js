...
var ASM_CONSTS = {
  4212433: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4212466: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4212537: () => { return Module.numWindows; },  
 4212567: () => { return Module.events.length; },  
 4212600: () => { window.id },  
 4212612: () => { return window.innerWidth },  
 4212639: () => { return window.innerHeight },  
 4212667: () => { return window.innerWidth },  
 4212694: () => { return window.innerHeight },  
 4212722: () => { return Date.now() / 1000.0; },  
 4212754: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
