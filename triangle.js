...
var ASM_CONSTS = {
  4209364: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4209397: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4209468: () => { return Module.numWindows; },  
 4209498: () => { return Module.events.length; },  
 4209531: () => { return Date.now() / 1000.0; }
};
...
var ___start_em_js = Module['___start_em_js'] = 4207424;
var ___stop_em_js = Module['___stop_em_js'] = 4209364;
