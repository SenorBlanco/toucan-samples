...
var ASM_CONSTS = {
  4209713: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4209746: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4209817: () => { return Module.numWindows; },  
 4209847: () => { return Module.events.length; },  
 4209880: () => { window.id },  
 4209892: () => { return window.innerWidth },  
 4209919: () => { return window.innerHeight },  
 4209947: () => { return window.innerWidth },  
 4209974: () => { return window.innerHeight },  
 4210002: () => { return Date.now() / 1000.0; },  
 4210034: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
...
var ___start_em_js = Module['___start_em_js'] = 4207800;
var ___stop_em_js = Module['___stop_em_js'] = 4209713;
