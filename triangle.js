...
var ASM_CONSTS = {
  4209524: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4209557: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4209628: () => { return Module.numWindows; },  
 4209658: () => { return Module.events.length; },  
 4209691: () => { return Date.now() / 1000.0; },  
 4209723: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
...
var ___start_em_js = Module['___start_em_js'] = 4207584;
var ___stop_em_js = Module['___stop_em_js'] = 4209524;
