...
var ASM_CONSTS = {
  4209660: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4209693: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4209764: () => { return Module.numWindows; },  
 4209794: () => { return Module.events.length; },  
 4209827: () => { return Date.now() / 1000.0; },  
 4209859: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
...
var ___start_em_js = Module['___start_em_js'] = 4207720;
var ___stop_em_js = Module['___stop_em_js'] = 4209660;
