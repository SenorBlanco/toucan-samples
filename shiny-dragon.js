...
function findWasmBinary() {
    return locateFile('shiny-dragon.wasm');
}
...
var ASM_CONSTS = {
  14176586: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 14176619: () => { return Module.numWindows; },  
 14176649: () => { return Module.events.length; },  
 14176682: () => { window.id },  
 14176694: () => { return window.innerWidth },  
 14176721: () => { return window.innerHeight },  
 14176749: () => { return window.innerWidth },  
 14176776: () => { return window.innerHeight },  
 14176804: () => { return Date.now() / 1000.0; },  
 14176836: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
