...
var ASM_CONSTS = {
  13953321: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 13953354: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 13953425: () => { return Module.numWindows; },  
 13953455: () => { return Module.events.length; },  
 13953488: () => { window.id },  
 13953500: () => { return window.innerWidth },  
 13953527: () => { return window.innerHeight },  
 13953555: () => { return window.innerWidth },  
 13953582: () => { return window.innerHeight },  
 13953610: () => { return Date.now() / 1000.0; },  
 13953642: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
