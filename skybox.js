...
var ASM_CONSTS = {
  13950316: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 13950349: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 13950420: () => { return Module.numWindows; },  
 13950450: () => { return Module.events.length; },  
 13950483: () => { return Date.now() / 1000.0; },  
 13950515: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
...
var ___start_em_js = Module['___start_em_js'] = 13948376;
var ___stop_em_js = Module['___stop_em_js'] = 13950316;
