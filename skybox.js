...
var ASM_CONSTS = {
  13956266: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 13956299: () => { return Module.numWindows; },  
 13956329: () => { return Module.events.length; },  
 13956362: () => { window.id },  
 13956374: () => { return window.innerWidth },  
 13956401: () => { return window.innerHeight },  
 13956429: () => { return window.innerWidth },  
 13956456: () => { return window.innerHeight },  
 13956484: () => { return Date.now() / 1000.0; },  
 13956516: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
