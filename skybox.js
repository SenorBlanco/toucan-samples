...
var ASM_CONSTS = {
  13950585: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 13950618: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 13950689: () => { return Module.numWindows; },  
 13950719: () => { return Module.events.length; },  
 13950752: () => { window.id },  
 13950764: () => { return window.innerWidth },  
 13950791: () => { return window.innerHeight },  
 13950819: () => { return window.innerWidth },  
 13950846: () => { return window.innerHeight },  
 13950874: () => { return Date.now() / 1000.0; },  
 13950906: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
...
var ___start_em_js = Module['___start_em_js'] = 13948672;
var ___stop_em_js = Module['___stop_em_js'] = 13950585;
