...
var ASM_CONSTS = {
  4211017: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4211050: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4211121: () => { return Module.numWindows; },  
 4211151: () => { return Module.events.length; },  
 4211184: () => { window.id },  
 4211196: () => { return window.innerWidth },  
 4211223: () => { return window.innerHeight },  
 4211251: () => { return window.innerWidth },  
 4211278: () => { return window.innerHeight },  
 4211306: () => { return Date.now() / 1000.0; },  
 4211338: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
