...
var ASM_CONSTS = {
  4208444: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4208477: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4208548: () => { return Module.numWindows; },  
 4208578: () => { return Module.events.length; },  
 4208611: () => { return Date.now() / 1000.0; },  
 4208643: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
...
var ___start_em_js = Module['___start_em_js'] = 4206504;
var ___stop_em_js = Module['___stop_em_js'] = 4208444;
