...
var ASM_CONSTS = {
  4209770: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4209803: () => { return Module.numWindows; },  
 4209833: () => { return Module.events.length; },  
 4209866: () => { window.id },  
 4209878: () => { return window.innerWidth },  
 4209905: () => { return window.innerHeight },  
 4209933: () => { return window.innerWidth },  
 4209960: () => { return window.innerHeight },  
 4209988: () => { return Date.now() / 1000.0; },  
 4210020: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
