...
var ASM_CONSTS = {
  4224844: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4224877: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4224948: () => { return Module.numWindows; },  
 4224978: () => { return Module.events.length; },  
 4225011: () => { return Date.now() / 1000.0; },  
 4225043: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
...
var ___start_em_js = Module['___start_em_js'] = 4222904;
var ___stop_em_js = Module['___stop_em_js'] = 4224844;
