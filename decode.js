...
var ASM_CONSTS = {
  4226650: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4226683: () => { return Module.numWindows; },  
 4226713: () => { return Module.events.length; },  
 4226746: () => { window.id },  
 4226758: () => { return window.innerWidth },  
 4226785: () => { return window.innerHeight },  
 4226813: () => { return window.innerWidth },  
 4226840: () => { return window.innerHeight },  
 4226868: () => { return Date.now() / 1000.0; },  
 4226900: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
