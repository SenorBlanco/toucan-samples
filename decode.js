...
var ASM_CONSTS = {
  4224876: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4224909: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4224980: () => { return Module.numWindows; },  
 4225010: () => { return Module.events.length; },  
 4225043: () => { return Date.now() / 1000.0; },  
 4225075: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
...
var ___start_em_js = Module['___start_em_js'] = 4222936;
var ___stop_em_js = Module['___stop_em_js'] = 4224876;
