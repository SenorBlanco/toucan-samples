...
var ASM_CONSTS = {
  4227569: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4227602: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4227673: () => { return Module.numWindows; },  
 4227703: () => { return Module.events.length; },  
 4227736: () => { window.id },  
 4227748: () => { return window.innerWidth },  
 4227775: () => { return window.innerHeight },  
 4227803: () => { return window.innerWidth },  
 4227830: () => { return window.innerHeight },  
 4227858: () => { return Date.now() / 1000.0; },  
 4227890: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
