...
var ASM_CONSTS = {
  4224833: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4224866: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4224937: () => { return Module.numWindows; },  
 4224967: () => { return Module.events.length; },  
 4225000: () => { window.id },  
 4225012: () => { return window.innerWidth },  
 4225039: () => { return window.innerHeight },  
 4225067: () => { return window.innerWidth },  
 4225094: () => { return window.innerHeight },  
 4225122: () => { return Date.now() / 1000.0; },  
 4225154: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
...
var ___start_em_js = Module['___start_em_js'] = 4222920;
var ___stop_em_js = Module['___stop_em_js'] = 4224833;
