...
var ASM_CONSTS = {
  4213460: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4213493: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4213564: () => { return Module.numWindows; },  
 4213594: () => { return Module.events.length; },  
 4213627: () => { return Date.now() / 1000.0; },  
 4213659: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
...
var ___start_em_js = Module['___start_em_js'] = 4211520;
var ___stop_em_js = Module['___stop_em_js'] = 4213460;
