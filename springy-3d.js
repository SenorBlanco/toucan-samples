...
var ASM_CONSTS = {
  4213580: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4213613: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4213684: () => { return Module.numWindows; },  
 4213714: () => { return Module.events.length; },  
 4213747: () => { return Date.now() / 1000.0; },  
 4213779: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
...
var ___start_em_js = Module['___start_em_js'] = 4211640;
var ___stop_em_js = Module['___stop_em_js'] = 4213580;
