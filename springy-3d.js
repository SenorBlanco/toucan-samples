...
function findWasmBinary() {
    return locateFile('springy-3d.wasm');
}
...
var ASM_CONSTS = {
  4214986: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4215019: () => { return Module.numWindows; },  
 4215049: () => { return Module.events.length; },  
 4215082: () => { window.id },  
 4215094: () => { return window.innerWidth },  
 4215121: () => { return window.innerHeight },  
 4215149: () => { return window.innerWidth },  
 4215176: () => { return window.innerHeight },  
 4215204: () => { return Date.now() / 1000.0; },  
 4215236: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
