...
var ASM_CONSTS = {
  4213300: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4213333: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4213404: () => { return Module.numWindows; },  
 4213434: () => { return Module.events.length; },  
 4213467: () => { return Date.now() / 1000.0; }
};
...
var ___start_em_js = Module['___start_em_js'] = 4211360;
var ___stop_em_js = Module['___stop_em_js'] = 4213300;
