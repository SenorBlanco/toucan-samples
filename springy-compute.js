...
var ASM_CONSTS = {
  4224692: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4224725: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4224796: () => { return Module.numWindows; },  
 4224826: () => { return Module.events.length; },  
 4224859: () => { return Date.now() / 1000.0; }
};
...
var ___start_em_js = Module['___start_em_js'] = 4222752;
var ___stop_em_js = Module['___stop_em_js'] = 4224692;
