...
var ASM_CONSTS = {
  4228873: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4228906: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4228977: () => { return Module.numWindows; },  
 4229007: () => { return Module.events.length; },  
 4229040: () => { window.id },  
 4229052: () => { return window.innerWidth },  
 4229079: () => { return window.innerHeight },  
 4229107: () => { return window.innerWidth },  
 4229134: () => { return window.innerHeight },  
 4229162: () => { return Date.now() / 1000.0; },  
 4229194: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
