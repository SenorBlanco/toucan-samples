...
function findWasmBinary() {
    return locateFile('springy-compute.wasm');
}
...
var ASM_CONSTS = {
  4226986: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4227019: () => { return Module.numWindows; },  
 4227049: () => { return Module.events.length; },  
 4227082: () => { window.id },  
 4227094: () => { return window.innerWidth },  
 4227121: () => { return window.innerHeight },  
 4227149: () => { return window.innerWidth },  
 4227176: () => { return window.innerHeight },  
 4227204: () => { return Date.now() / 1000.0; },  
 4227236: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
