...
var ASM_CONSTS = {
  4225108: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4225141: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4225212: () => { return Module.numWindows; },  
 4225242: () => { return Module.events.length; },  
 4225275: () => { return Date.now() / 1000.0; },  
 4225307: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
...
var ___start_em_js = Module['___start_em_js'] = 4223168;
var ___stop_em_js = Module['___stop_em_js'] = 4225108;
