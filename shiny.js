...
var ASM_CONSTS = {
  13961153: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 13961186: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 13961257: () => { return Module.numWindows; },  
 13961287: () => { return Module.events.length; },  
 13961320: () => { window.id },  
 13961332: () => { return window.innerWidth },  
 13961359: () => { return window.innerHeight },  
 13961387: () => { return window.innerWidth },  
 13961414: () => { return window.innerHeight },  
 13961442: () => { return Date.now() / 1000.0; },  
 13961474: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
