...
var ASM_CONSTS = {
  13957956: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 13957989: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 13958060: () => { return Module.numWindows; },  
 13958090: () => { return Module.events.length; },  
 13958123: () => { return Date.now() / 1000.0; },  
 13958155: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
...
var ___start_em_js = Module['___start_em_js'] = 13956016;
var ___stop_em_js = Module['___stop_em_js'] = 13957956;
