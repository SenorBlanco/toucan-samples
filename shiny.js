...
var ASM_CONSTS = {
  13966682: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 13966715: () => { return Module.numWindows; },  
 13966745: () => { return Module.events.length; },  
 13966778: () => { window.id },  
 13966790: () => { return window.innerWidth },  
 13966817: () => { return window.innerHeight },  
 13966845: () => { return window.innerWidth },  
 13966872: () => { return window.innerHeight },  
 13966900: () => { return Date.now() / 1000.0; },  
 13966932: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
