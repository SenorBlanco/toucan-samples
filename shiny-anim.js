...
function findWasmBinary() {
    return locateFile('shiny-anim.wasm');
}
...
var ASM_CONSTS = {
  13966698: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 13966731: () => { return Module.numWindows; },  
 13966761: () => { return Module.events.length; },  
 13966794: () => { window.id },  
 13966806: () => { return window.innerWidth },  
 13966833: () => { return window.innerHeight },  
 13966861: () => { return window.innerWidth },  
 13966888: () => { return window.innerHeight },  
 13966916: () => { return Date.now() / 1000.0; },  
 13966948: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
