...
var ASM_CONSTS = {
  13961185: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 13961218: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 13961289: () => { return Module.numWindows; },  
 13961319: () => { return Module.events.length; },  
 13961352: () => { window.id },  
 13961364: () => { return window.innerWidth },  
 13961391: () => { return window.innerHeight },  
 13961419: () => { return window.innerWidth },  
 13961446: () => { return window.innerHeight },  
 13961474: () => { return Date.now() / 1000.0; },  
 13961506: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
