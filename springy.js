...
var ASM_CONSTS = {
  4213660: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4213693: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4213764: () => { return Module.numWindows; },  
 4213794: () => { return Module.events.length; },  
 4213827: () => { return Date.now() / 1000.0; },  
 4213859: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
...
var ___stop_em_js = Module['___stop_em_js'] = 4213660;
