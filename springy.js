...
var ASM_CONSTS = {
  4216353: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4216386: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4216457: () => { return Module.numWindows; },  
 4216487: () => { return Module.events.length; },  
 4216520: () => { window.id },  
 4216532: () => { return window.innerWidth },  
 4216559: () => { return window.innerHeight },  
 4216587: () => { return window.innerWidth },  
 4216614: () => { return window.innerHeight },  
 4216642: () => { return Date.now() / 1000.0; },  
 4216674: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
