...
var ASM_CONSTS = {
  4446737: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4446770: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 4446841: () => { return Module.numWindows; },  
 4446871: () => { return Module.events.length; },  
 4446904: () => { window.id },  
 4446916: () => { return window.innerWidth },  
 4446943: () => { return window.innerHeight },  
 4446971: () => { return window.innerWidth },  
 4446998: () => { return window.innerHeight },  
 4447026: () => { return Date.now() / 1000.0; },  
 4447058: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
