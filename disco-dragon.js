...
function findWasmBinary() {
    return locateFile('disco-dragon.wasm');
}
...
var ASM_CONSTS = {
  4441866: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 4441899: () => { return Module.numWindows; },  
 4441929: () => { return Module.events.length; },  
 4441962: () => { window.id },  
 4441974: () => { return window.innerWidth },  
 4442001: () => { return window.innerHeight },  
 4442029: () => { return window.innerWidth },  
 4442056: () => { return window.innerHeight },  
 4442084: () => { return Date.now() / 1000.0; },  
 4442116: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
