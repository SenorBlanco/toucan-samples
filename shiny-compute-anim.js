...
function findWasmBinary() {
    return locateFile('shiny-compute-anim.wasm');
}
...
var ASM_CONSTS = {
  13973786: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 13973819: () => { return Module.numWindows; },  
 13973849: () => { return Module.events.length; },  
 13973882: () => { window.id },  
 13973894: () => { return window.innerWidth },  
 13973921: () => { return window.innerHeight },  
 13973949: () => { return window.innerWidth },  
 13973976: () => { return window.innerHeight },  
 13974004: () => { return Date.now() / 1000.0; },  
 13974036: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
