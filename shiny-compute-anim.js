...
var wasmBinaryFile;
  wasmBinaryFile = 'shiny-compute-anim.wasm';
...
var ASM_CONSTS = {
  13964865: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 13964898: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 13964969: () => { return Module.numWindows; },  
 13964999: () => { return Module.events.length; },  
 13965032: () => { window.id },  
 13965044: () => { return window.innerWidth },  
 13965071: () => { return window.innerHeight },  
 13965099: () => { return window.innerWidth },  
 13965126: () => { return window.innerHeight },  
 13965154: () => { return Date.now() / 1000.0; },  
 13965186: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
...
var ___start_em_js = Module['___start_em_js'] = 13962952;
var ___stop_em_js = Module['___stop_em_js'] = 13964865;
