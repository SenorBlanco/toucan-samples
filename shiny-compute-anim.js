...
var ASM_CONSTS = {
  13968433: ($0, $1, $2, $3) => { createWindow($0, $1, $2, $3) },  
 13968466: () => { Module.numWindows = 0; Module.events = []; Module.newInput = null; },  
 13968537: () => { return Module.numWindows; },  
 13968567: () => { return Module.events.length; },  
 13968600: () => { window.id },  
 13968612: () => { return window.innerWidth },  
 13968639: () => { return window.innerHeight },  
 13968667: () => { return window.innerWidth },  
 13968694: () => { return window.innerHeight },  
 13968722: () => { return Date.now() / 1000.0; },  
 13968754: () => { return WebGPU.Int_PreferredFormat[navigator.gpu.getPreferredCanvasFormat()]; }
};
...
var wasmImports = {
  ...
  /** @export */
  __asyncjs__JSInitDevice,
  /** @export */
  __asyncjs__JSMapSync,
  /** @export */
